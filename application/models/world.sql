...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2022 at 04:48 AM
...
(8, 'Utrecht NLD', 'NLD', 'Utrecht', 2343230),
...
(4080, 'Soreang', 'IDN', 'Jabar', 666000),
(4081, 'Cibeber', 'IDN', 'Cimahi', 2),
(4082, 'Cimahi Tengah', 'IDN', 'Jawa Barat', 1000),
(4083, 'Lab MIPA', 'IDN', 'Jawa Barat', 1),
(4084, 'Kota Baru Unjani', 'IDN', 'Cimahi', 302),
(4086, 'Kota Baru New Unjani', 'IDN', 'Cimahi', 105),
(4087, 'Bonimo', 'IDN', 'Metaverse', 1000000000);

--
-- Triggers `city`
--
DELIMITER $$
CREATE TRIGGER `delete_kota` AFTER DELETE ON `city` FOR EACH ROW BEGIN
	-- DEKLARASI VARIABEL "populasi"
	DECLARE populasi INT(11) DEFAULT 0;
	-- MENGISI VARIABEL populasi DENGAN NILAI POPULASI DARI TABEL NEGARA
	SELECT Population INTO populasi
	FROM country
    WHERE country.Code = old.CountryCode;
    -- MENGHITUNG PENAMBAHAN POPULASI
	SET populasi = populasi - old.Population;
	-- UPDATE KE TABEL NEGARA NILAI POPULASI YANG BARU
    UPDATE country SET Population = populasi WHERE country.Code = old.CountryCode;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `tambah_kota` AFTER INSERT ON `city` FOR EACH ROW BEGIN
	DECLARE pop INT(11) DEFAULT 0;
	SELECT Population INTO pop
	FROM country
    WHERE country.Code = new.CountryCode;
    -- object old atau new
	SET pop = pop + new.Population;
    UPDATE country SET Population = pop WHERE country.Code = new.CountryCode;
END
$$
DELIMITER ;
...
('IDN', 'Indonesia', 'Asia', 'Southeast Asia', '1904569.00', 1945, 1038153105, '68.0', '84982.00', '215002.00', 'Indonesia', 'Republic', 'Abdurrahman Wahid', 939, 'ID'),
